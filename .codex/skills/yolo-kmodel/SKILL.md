---
name: yolo-kmodel
description: Convert a finished YOLOv5 v7.0 detection checkpoint in this project to a K230 kmodel with the local K230_Yolov5n toolchain, then verify and prepare deployment configuration. Use for K230 model conversion or kmodel verification; do not use for ordinary YOLO inference.
---

# YOLOv5 到 K230 kmodel
